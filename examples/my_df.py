...
def dataflow():
    ...
    for function in prog["functions"]:
        ...
        reaching_definitions = ReachingDefinitions(blocks)
        ...
        in_ = {block_name: set() for block_name in blocks.keys()}
        # same as in
        out = {block_name: set() for block_name in blocks.keys()}
        ...
        while len(worklist) > 0:
            ...
            in_[block_name] = reaching_definitions.merge(out[pred] for pred in preds[block_name])
